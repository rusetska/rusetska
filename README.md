...
|----|----------------------------|--------------------------------------|-----------------------------|
| pet-проект |[Анализ категорий контента мобильного приложения коротких вертикальных видео](https://github.com/rusetska/Portfolio/tree/main/categorized_content_analytics)|Анализ метрик для отдела маркетинга. Результаты реального исследования повлияли на бизнес: пересмотрены подходы к разметке контента и скорректированы рекомендации для разных категорий пользователей.|pandas, python, matplotlib, seaborn, plotly|
