...
|----|----------------------------|--------------------------------------|-----------------------------|
| pet-проект |[Анализ категорий контента мобильного приложения коротких вертикальных видео](https://github.com/rusetska/Portfolio/tree/main/categorized_content_analytics)|Аналитическое исследование категорий контента и пользовательских метрик. Проект основан на реальной бизнес-задаче, данные синтетические. Выявлены различия, аномалии и сформированы гипотезы для дальнейшей аналитической и продуктовой работы.|pandas, python, matplotlib, seaborn, plotly|
